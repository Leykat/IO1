%Leidy Vargas M
%15/05/2019
%Enunciado1 Maximización
%Un estanque de peces es abastecido cada primavera con dos especies: beta y globo;
% si hay dos tipos de comida f1 y f2 disponibles en el tanque. El peso promedio de los peces y
% el requerimiento promedio de alimento para cada pez; esta dado en la siguiente tabla:
%Especie/ F1/ F2 / Peso promedio
% beta   2    3      3 lb
% globo  3    1      2 lb
%Si existen 600 lb de comida f1 y 300 lb de comida f2 diariamente.
% ¿Cuántos peces deben existir en la pecera; dado que lo mínimo para lo cual fue construida es de 400 lb?
%X1:No peces beta que deben haber X2:No peces globo que deben haber
...
%A=[1 1]; %Se define A como funcion objetivo

%B=[ 3 2; %%Se define B como restricciones
%   2 3;
%   3 1];

%C=[ 400; %% vector de recursos de las desigualdades 
%   600;
%   300];                                        
%%


function granM_Aplicacion1()
clc;
clear all;
A=[1 1];
B=[ 3 2; 
...
disp('============================================================================');
disp('SOLUCIÓN')
disp(['Los peces tipo beta deberán ser:  ',num2str(Q(3)),' peces']);
disp(['Los peces tipo globo deberán ser: ',num2str(Q(1)),' peces']);
disp(['Y la cantidad que debe existir en la pecera es de:',num2str(Z),' peces']);
