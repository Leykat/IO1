%Leidy Vargas M
%15/05/2019
%Enunciado2 Minimización
%Dos empresas mineras extraen dos tipos  diferentes de minerales los cuales son sometidos a un proceso de trituración
% con tres grados (alto, medio, bajo).Las compañías han firmado un contrato para proveer mineral a una plata de
% fundición cada semana, 12 toneladas de mineral de grado alto, 8 de grado medio y 24 de grado bajo,
% cada una de las empresas tiene diferentes procesos de fabricación.
%¿Cuantos días a la semana deberían de operar cada empresa para cumplir el contrato con la planta de fundición?
%Minas/ Costo-día/ Producción (toneladas / día)
%                   alto/ medio/ bajo
% X1        180      6      3       4
% X2        160      1      1       6
                                    %Min z=180x1+160x2
...
%A=[180 160]; %Se define A como funcion objetivo

%B=[ 6 1; %%Se define B como restricciones
%   3 1;
%   4 6];

%C=[ 12; %% vector de recursos de las desigualdades 
%   8;
%   24]; 
%%

function granM_Aplicacion2()
clc;
clear all;
A=[180 160]; %Se define A como funcion objetivo
...
disp('============================================================================');
disp('SOLUCIÓN')
disp(['La empresa X1 operará:  ',num2str(Q(1)),' días a la semana']);
disp(['La empresa X2 operará: ',num2str(Q(3)),' días a la semana']);
disp(['El costo de opereación será de:',num2str(Z),' dólares']);
