...
%x2 = kilogramos de alimento B. 
                            %min z= = 60x1 + 210x2
                             %s.a.: 1000 x1+  2000x2  ≥3000 
                             %      25x1 +  100x2   ≥100
                             %          x1, x2 ≥0
%A=[60 210]; %Se define A como funcion objetivo

%B=[1000 2000; %%Se define B como restricciones
% 25 100];

%C=[ 3000; %% vector de recursos de las desigualdades 
%   100];
 %%
...
A=[1000 2000 3000;
    25 100 100;
    60 210 0]; %Se define A como matriz inicial
TRANSPUESTA = A.' 
A=TRANSPUESTA([3],[1,2])
...
disp('============================================================================');
disp('SOLUCIÓN')
disp(['Siendo : ',num2str(Cj_Zj(3)*-1),' kilogramos de alimento A.']);
disp(['Siendo: ',num2str(Cj_Zj(4)*-1),' kilogramos de alimento B.']);
disp(['El coste mínimo de una dieta formada sólo por este tipo de alimentos es:',num2str(Z),' pesetas']);
